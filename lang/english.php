...
$_ADDONLANG = [
    ...
    'activityHistory_request' => "Request",
    'activityHistory_response' => "Response",
    'activityHistory_client' => "Client",
    'activityHistory_invoice' => "Invoice",
    'activityHistory_client_id' => "Client ID",
    'clear_logs' => 'Clear Logs',
    'clear_counters' => 'Clear Counters',
    'clearing' => 'Clearing...',
    'logs_cleared' => 'All activity logs have been cleared successfully.',
    'counters_cleared' => 'All access counters have been reset to zero.',
    'error_clearing_logs' => 'An error occurred while clearing the logs. Please try again.',
    'error_clearing_counters' => 'An error occurred while clearing the counters. Please try again.',
    'confirm_clear_logs_message' => 'Are you sure you want to clear all activity logs? This action cannot be undone.',
    'confirm_clear_counters_message' => 'Are you sure you want to reset all access counters to zero? This action cannot be undone.',
    ...
    'confirm_clear_links_message' => 'Are you sure you want to clear all guest links? This action cannot be undone.',
    'links_cleared' => 'All guest links have been cleared successfully.',
    'error_clearing_links' => 'An error occurred while clearing the links. Please try again.',
    ...
    'nav_activity_history'      => 'Activity History',
